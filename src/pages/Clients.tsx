        ...
        <section className="relative py-16">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <motion.div
              ...
              className="rx-auto max-w-3xl mx-auto"
            >
              <StarBorder as="div" className="w-full h-full rounded-3xl" color="white" speed="60s">
                <div className="rounded-3xl border-0 bg-glass/30 backdrop-blur-md p-12 text-center overflow-hidden relative">
